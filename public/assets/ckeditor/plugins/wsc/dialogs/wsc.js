...
(function () {
    ...
    var J = function (b) {
        ...
        for (d in b) {
            if (c = a.dialog.getContentElement(a.dialog._.currentTabId,
                    d))c = c.getElement(); else if (b[d].instance)c = b[d].instance.getElement().getFirst() || b[d].instance.getElement(); else continue;
    ...
    a.buildOptionLang =
        function (b, c) {
            var e = document.getElementById("wscLang" + c), d = document.createDocumentFragment(), f, h, k = [];
    ...
    var B = function (a) {
        ...
        grammerSuggest: function (b) {
            ...
            }, g.postMessage.send({message: e, target: a.targetFromFrame[void 0]})) : c = "");
        ...
        var b = a.dialog.getContentElement(a.dialog._.currentTabId, "BlockFinishChecking").getElement(), c = document.activeElement, e;
        b.setStyles({display: "block", position: "absolute", left: "-9999px"});
        setTimeout(function () {
            b.removeStyle("display");
            b.removeStyle("position");
            ...
            a.dialog._.editor.focusManager.currentActive.focusNext();
            e = g.misc.findFocusable(a.dialog.parts.contents);
            if (g.misc.hasClass(c, "cke_dialog_tab") || g.misc.hasClass(c, "cke_dialog_contents_body") || !g.misc.isVisible(c))for (var d =
                0, f; d < e.count(); d++) {
                if (f = e.getItem(d), g.misc.isVisible(f.$)) {
                    try {
                        f.$.focus()
    ...
    CKEDITOR.dialog.add("checkspell", function (b) {
        function c(a) {
            ...
            if (!a._.resized) {
                var r = n.height - a.parts.contents.getSize("height", !(CKEDITOR.env.gecko ||
                    CKEDITOR.env.opera || CKEDITOR.env.ie && CKEDITOR.env.quirks)), D = n.width - a.parts.contents.getSize("width", 1);
        ...
        var d = function (c) {
            ...
            var d = a.iframeNumber + "_" +
                c, e = a.textNode[c].getValue(), f = this.getElement().getAttribute("title-cmd");
            g.postMessage.send({
            ...
            onShow: function () {
                ...
                if (CKEDITOR && CKEDITOR.config) {
                    ...
                    var d = "file:" == document.location.protocol ?
                        "http:" : document.location.protocol, d = b.config.wsc_customLoaderScript || d + "//www.webspellchecker.net/spellcheck3/script/ssrv.cgi?plugin\x3dfck2\x26customerid\x3d" + a.wsc_customerId + "\x26cmd\x3dscript\x26doc\x3dwsc\x26schema\x3d22";
                    c(this);
