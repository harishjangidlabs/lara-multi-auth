...
(function () {
    CKEDITOR.dialog.add("link", function (c) {
        ...
        var n = CKEDITOR.plugins.link, q, r = function () {
            var a = this.getDialog(), b = a.getContentElement("target", "popupFeatures"), a = a.getContentElement("target", "linkTargetName"), p = this.getValue();
        ...
        return {
                    ...
                    type: "vbox", id: "urlOptions", children: [{
                        type: "hbox", widths: ["25%", "75%"], children: [{
                            ...
                            type: "text", id: "url", label: g.url, required: !0, onLoad: function () {
                                ...
                                var a = this.getDialog().getContentElement("info", "protocol"), b = this.getValue(), c = /^((javascript:)|[#\/\.\?])/i,
            ...
            onShow: function () {
                var a = this.getParentEditor(), b = a.getSelection(), c = this.getContentElement("info", "linkDisplayText").getElement().getParent().getParent(), f = n.getSelectedLink(a, !0), h = f[0] || null;
