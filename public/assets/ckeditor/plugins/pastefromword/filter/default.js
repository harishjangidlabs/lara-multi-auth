...
(function () {
    ...
    var g, k, t, q, n = CKEDITOR.tools, y = ["o:p", "xml", "script", "meta", "link"], w = {}, v = 0;
        ...
        q = new CKEDITOR.htmlParser.filter({
            ...
            elements: {
                a: function (e) {
                    ...
                    var c = a.getAscendant("table"), d = c._tdBorders, f = ["border", "border-top", "border-right", "border-bottom", "border-left"], c = n.parseCssText(c.attributes.style), m = c.background || c.BACKGROUND;
                    m && k.setStyle(a, "background", m, !0);
                    (c = c["background-color"] || c["BACKGROUND-COLOR"]) && k.setStyle(a, "background-color",
                        c, !0);
                    var c = n.parseCssText(a.attributes.style), p;
    ...
    CKEDITOR.plugins.pastefromword.styles = {
        ...
        mapStyles: function (a, b) {
            ...
            }, e = b && !0 === b.config.pasteFromWordRemoveFontStyles, h = n.parseCssText(a.attributes.style);
            ...
            for (var l = n.objectKeys(h), r = 0; r < l.length; r++) {
                var m = l[r].toLowerCase(), p = h[l[r]], k = CKEDITOR.tools.indexOf;
            ...
            f.sort(function (a, c) {
                var d = n.indexOf(b, a.toLowerCase()), f = n.indexOf(b, c.toLowerCase());
                return d -
                    f
            });
            d = [].concat(f, e);
            ...
            var d = {
                ...
                border: !0,
                "border-": !0
            }, f = n.parseCssText(a.attributes.style), e;
            ...
            parse: function (a) {
                ...
                var d = CKEDITOR.tools.parseCssText, f = CKEDITOR.plugins.pastefromword.styles.inliner.filter, e = a.is ? a.$.sheet : b(a);
                a = [];
                var h;
            ...
            sort: function (a) {
                return a.sort(function (a) {
                    ...
                    return function (a, b) {
                        var e = -1 !== ("" + a.selector).indexOf(".") ? 1 : 0, e = (-1 !== ("" + b.selector).indexOf(".") ? 1 : 0) - e;
    ...
    CKEDITOR.plugins.pastefromword.lists =
    {
        ...
        for (a = 0; a < e.length; a++) {
            ...
            var l = [g.createList(l)], k = l[0], m = [l[0]];
            k.insertBefore(h[0]);
            for (d = 0; d < h.length; d++) {
                b = h[d];
                for (c = b.attributes["cke-list-level"]; c > l.length;) {
                    var p = g.createList(b), n = k.children;
                    0 < n.length ? n[n.length - 1].add(p) : (n = new CKEDITOR.htmlParser.element("li", {style: "list-style-type:none"}), n.add(p), k.add(n));
                    l.push(p);
                    m.push(p);
                    k = p;
        ...
        e.forEach(m, function (a) {
            var g = a.attributes.type, h = parseInt(a.attributes.start, 10) || 1, m = c(f, a) + 1;
        ...
        for (var c = {}, d = [[]], f, e = 0; e < a.length; e++) {
            var h = c[a[e].attributes["cke-list-level"]], l = this.getListItemInfo(a[e]), k, m;
